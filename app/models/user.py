...
class User(db.Model, UserMixin):
    ...
    tweets = db.relationship('Tweet', back_populates='tweet_author', cascade='all, delete')
    liked_tweets = db.relationship('Tweet', secondary=likes, back_populates='liked_by_users')
